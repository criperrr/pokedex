// interfaces que espelham exatamente a resposta bruta da PokeAPI REST
// usadas apenas dentro de src/services/pokeApi.ts para tipagem das respostas fetch
// eu fiz essa função fazendo um fetch no pikachu e colando a resposta no https://transform.tools/json-to-typescript
