...
interface EvolutionChainBannerProps {
  paths: EvolutionStage[][];
  currentId: number;
  accentColor: string;
        ...
        {mainPath.map((stage, i) => {
          ...
          return (
            <React.Fragment key={stage.id}>
              {i > 0 && (
                <Text style={[styles.evoBannerArrow, { color: accentColor }]}>
                  ▶
                </Text>
              )}
              <TouchableOpacity
