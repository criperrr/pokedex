...
export default function App() {
  ...
  return <NavigationContainer theme={temaAtual}>
      <Drawer.Navigator drawerContent={props => <CustomDrawer {...props} isDarkMode={isDarkMode} onToggleTheme={alternarTema} />} screenOptions={{
      sceneStyle: {
